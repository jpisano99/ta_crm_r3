...
def sub_analysis(cust_name):
    ...
    print("Customer Subscriptions Records for:", cust_name, sub_recs.rowcount)
    ...
    # print('Returns', sub_list[0])

    if len(sub_list) == 0:
        sub_list.append(['No Subscriptions Found', '', '', '', '',
                        '', '', ''])
    return sub_list[0]
