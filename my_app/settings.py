...
app_cfg = dict(
    ...
    # UPDATES_SUB_DIR='app_updates 03-30-20',
    # UPDATES_SUB_DIR='app_updates 05-27-20',
    UPDATES_SUB_DIR='app_updates 11-23-20',
    # UPDATES_SUB_DIR='deal_size_analysis',
    ...
    SS_COVERAGE='FY21 Tetration Coverage Map',
